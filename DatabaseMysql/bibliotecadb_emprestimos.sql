...
CREATE TABLE `emprestimos` (
  ...
  KEY `IX_Emprestimos_UsuarioId` (`UsuarioId`),
  CONSTRAINT `FK_Emprestimos_Livros_LivroId` FOREIGN KEY (`LivroId`) REFERENCES `livros` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `FK_Emprestimos_Usuarios_UsuarioId` FOREIGN KEY (`UsuarioId`) REFERENCES `usuarios` (`Id`) ON DELETE CASCADE
...
-- Dump completed on 2025-12-17 12:42:39
